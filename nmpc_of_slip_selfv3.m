...
for i=1:length(t)
    ...
    if i>2
    plot(z(i-2:i,1),z(i-2:i,3),'ro','MarkerEdgeColor','black', 'MarkerFaceColor','black','MarkerSize',10); %com
    end
    if i>3
    plot(z(i-3:i,1),z(i-3:i,3),'ro','MarkerEdgeColor','black', 'MarkerFaceColor','black','MarkerSize',10); %com
    end
    if i>4
    plot(z(i-4:i,1),z(i-4:i,3),'ro','MarkerEdgeColor','black', 'MarkerFaceColor','black','MarkerSize',10); %com
    end
    ...
    if(i>2)
        line([z(i-1,1) z(i-1,5)],[z(i-1,3) z(i-1,6)],'Linewidth',4,'Color',[0.8 0 0 0.5]); %leg
    end
    if(i>3)
        line([z(i-2,1) z(i-2,5)],[z(i-2,3) z(i-2,6)],'Linewidth',4,'Color',[0.8 0 0 0.4]); %leg
        line([z(i-1,1) z(i-1,5)],[z(i-1,3) z(i-1,6)],'Linewidth',4,'Color',[0.8 0 0 0.5]); %leg
    end
    
    if(i>4)
        line([z(i-3,1) z(i-3,5)],[z(i-3,3) z(i-3,6)],'Linewidth',4,'Color',[0.8 0 0 0.3]); %leg
        line([z(i-2,1) z(i-2,5)],[z(i-2,3) z(i-2,6)],'Linewidth',4,'Color',[0.8 0 0 0.4]); %leg
        line([z(i-1,1) z(i-1,5)],[z(i-1,3) z(i-1,6)],'Linewidth',4,'Color',[0.8 0 0 0.5]); %leg
    end
    if(i>5)
        line([z(i-4,1) z(i-4,5)],[z(i-4,3) z(i-4,6)],'Linewidth',4,'Color',[0.8 0 0 0.2]); %leg
        line([z(i-3,1) z(i-3,5)],[z(i-3,3) z(i-3,6)],'Linewidth',4,'Color',[0.8 0 0 0.3]); %leg
        line([z(i-2,1) z(i-2,5)],[z(i-2,3) z(i-2,6)],'Linewidth',4,'Color',[0.8 0 0 0.4]); %leg
        line([z(i-1,1) z(i-1,5)],[z(i-1,3) z(i-1,6)],'Linewidth',4,'Color',[0.8 0 0 0.5]); %leg
    end
%     if(i>6)
%         line([z(i-5,1) z(i-5,5)],[z(i-5,3) z(i-5,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-4,1) z(i-4,5)],[z(i-4,3) z(i-4,6)],'Linewidth',4,'Color',[0.8 0 0 0.2]); %leg
%         line([z(i-3,1) z(i-3,5)],[z(i-3,3) z(i-3,6)],'Linewidth',4,'Color',[0.8 0 0 0.3]); %leg
%         line([z(i-2,1) z(i-2,5)],[z(i-2,3) z(i-2,6)],'Linewidth',4,'Color',[0.8 0 0 0.4]); %leg
%         line([z(i-1,1) z(i-1,5)],[z(i-1,3) z(i-1,6)],'Linewidth',4,'Color',[0.8 0 0 0.5]); %leg
%     end
%     if(i>7)
%         line([z(i-6,1) z(i-6,5)],[z(i-6,3) z(i-6,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-5,1) z(i-5,5)],[z(i-5,3) z(i-5,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-4,1) z(i-4,5)],[z(i-4,3) z(i-4,6)],'Linewidth',4,'Color',[0.8 0 0 0.2]); %leg
%         line([z(i-3,1) z(i-3,5)],[z(i-3,3) z(i-3,6)],'Linewidth',4,'Color',[0.8 0 0 0.3]); %leg
%         line([z(i-2,1) z(i-2,5)],[z(i-2,3) z(i-2,6)],'Linewidth',4,'Color',[0.8 0 0 0.4]); %leg
...
%     end
%     if(i>8)
%         line([z(i-7,1) z(i-7,5)],[z(i-7,3) z(i-7,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-6,1) z(i-6,5)],[z(i-6,3) z(i-6,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-5,1) z(i-5,5)],[z(i-5,3) z(i-5,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-4,1) z(i-4,5)],[z(i-4,3) z(i-4,6)],'Linewidth',4,'Color',[0.8 0 0 0.2]); %leg
%         line([z(i-3,1) z(i-3,5)],[z(i-3,3) z(i-3,6)],'Linewidth',4,'Color',[0.8 0 0 0.3]); %leg
...
%     end
%     if(i>9)
%         line([z(i-8,1) z(i-8,5)],[z(i-8,3) z(i-8,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-7,1) z(i-7,5)],[z(i-7,3) z(i-7,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-6,1) z(i-6,5)],[z(i-6,3) z(i-6,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-5,1) z(i-5,5)],[z(i-5,3) z(i-5,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-4,1) z(i-4,5)],[z(i-4,3) z(i-4,6)],'Linewidth',4,'Color',[0.8 0 0 0.2]); %leg
...
%     end
%     if(i>10)
%         line([z(i-9,1) z(i-9,5)],[z(i-9,3) z(i-9,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-8,1) z(i-8,5)],[z(i-8,3) z(i-8,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-7,1) z(i-7,5)],[z(i-7,3) z(i-7,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-6,1) z(i-6,5)],[z(i-6,3) z(i-6,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
%         line([z(i-5,1) z(i-5,5)],[z(i-5,3) z(i-5,6)],'Linewidth',4,'Color',[0.8 0 0 0.1]); %leg
